...
export const metadata: Metadata = {
	title: 'Christian Luke - Developer',
	description:
	...
	authors: [{ name: 'Christian Luke' }],
	creator: 'Christian Luke',
	openGraph: {
		title: 'Christian Luke - Developer Portfolio',
		description: 'Passionate developer creating simple and effective solutions. Explore my projects and development approach.',
		url: 'https://christian-luke.com',
		siteName: 'Christian Luke - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Christian Luke - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
